...
#Checking if valid parameters are passed
if [ -z "$1" ]
then 
	echo "Please enter Region Name"
	echo "Format should be in sequence : ' Region 'VPC-CIDR'  'SUBNET1_CIDR' 'SUBNET2_CIDR' 'SUBNET3_CIDR' 'VPC Name'"
	exit 1
else
	if [ -z "$2" ]
	then 
